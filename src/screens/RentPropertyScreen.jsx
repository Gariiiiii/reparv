...
export default function RentPropertyScreen() {
  ...
  const cardData = [
    {title: 'Flat For Rent', img: FlatImg},
    {title: 'Villa For Rent', img: VillaImg},
    {title: 'Independent House For Rent', img: IndependentHouseImg},
    {title: 'Shop For Rent', img: ShopImg},
    {title: 'Office For Rent', img: OfficeImg},
    {title: 'Godown For Rent', img: GodownImg},
    {title: 'Showroom For Rent', img: ShowroomImg},
    {title: 'Open Land For Rent', img: OpenLandImg},
  ];

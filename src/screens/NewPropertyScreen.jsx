...
export default function NewPropertyScreen() {
  ...
  const cardData = [
    {title: 'Buy New Flat', img: FlatImg},
    {title: 'Buy Row House', img: LandImg},
    {title: 'Buy New Shop', img: ShopImg},
    {title: 'Buy Office Space', img: OfficeImg},
    {title: 'Buy Bungalow', img: BungalowImg},
    {title: 'Buy Godown', img: GodownImg},
    {title: 'Buy New Farm House', img: FarmHouseImg},
    {title: 'Buy Row House', img: RowHouseImg},
  ];
